...
Description: 
Autor: Jiachen Sun
Date: 2021-04-14 16:39:24
LastEditors: Jiachen Sun
LastEditTime: 2021-04-14 17:45:04
'''
...
def adversarial(args,io,model=None, dataloader=None):
    ...
    for data, label,_,_ in test_loader:
        ...
        if args.attack == 'pgd':
            adv_data = attack.pgd_attack(model1,data,label,eps=args.eps,alpha=args.alpha,iters=args.test_iter,repeat=1,mixup=False)
        ...
        test_pred1.append(preds.detach().cpu().numpy())
    ...
    test_acc1 = metrics.accuracy_score(test_true, test_pred1)
    ...
    outstr = ' Adversarial :: ADV_test acc: %.6f  %.6f  %.6f'  %(test_acc1,test_acc2,test_acc3)
...
if __name__ == "__main__":
    ...
    args.model_path1, args.model_path2, args.model_path3 = args.model_path2, args.model_path1, args.model_path3 
    adversarial(args=args,io=io)
    args.model_path1, args.model_path2, args.model_path3 = args.model_path3, args.model_path2, args.model_path1
    adversarial(args=args,io=io)
